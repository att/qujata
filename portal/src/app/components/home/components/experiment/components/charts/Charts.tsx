...
import { barChartTooltipKeys, barChartTooltipLabels } from './models/bar-chart.const';
        ...
        <div className={styles.charts_wrapper}>
          ...
          <div className={styles.chart_wrapper}>
            {barChartKeysOfData.map((key) => (
                <BarChart key={key} title={getChartTitleByType(key)} labels={barChartLabels} data={barChartData} tooltipKeys={barChartTooltipKeys} tooltipLabels={barChartTooltipLabels} keyOfData={key} />
            ))}
