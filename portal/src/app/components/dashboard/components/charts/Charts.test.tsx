...
describe('Charts', () => {
  ...
  beforeAll(() => {
    ...
    const sampleData: Partial<ITestResponseData> = {
      serverMemory: [10, 20, 30],
      serverCpu: [40, 50, 60],
      clientMemory: [70, 80, 90],
      clientCpu: [100, 110, 120],
    };
  ...
  test('should render Charts', () => {
    ...
    const { container }: RenderResult = render(<Charts {...props} />);
  ...
  xtest('should check all values were rendered', () => {
    ...
    const { getByText }: RenderResult = render(<Charts {...props} />);
    
    expect(getByText('Server Memory (%)')).toBeInTheDocument();
    expect(getByText('Server CPU (%)')).toBeInTheDocument();
    expect(getByText('Client Memory (%)')).toBeInTheDocument();
    expect(getByText('Client CPU (%)')).toBeInTheDocument();
  });
});
