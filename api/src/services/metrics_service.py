...
def create(test_run, client_metrics, server_metrics, data_bytes, start_time, end_time):
    __save_resource_metrics(Metric.CLIENT_AVERAGE_CPU_CORES, Metric.CLIENT_AVERAGE_CPU, Metric.CLIENT_AVERAGE_MEMORY, client_metrics, test_run)
    __save_resource_metrics(Metric.SERVER_AVERAGE_CPU_CORES, Metric.SERVER_AVERAGE_CPU, Metric.SERVER_AVERAGE_MEMORY, server_metrics, test_run)
...
def __save_resource_metrics(cpu_cores_metric_name, cpu_metric_name, memory_metric_name, metrics, test_run):
